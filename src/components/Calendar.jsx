    ...
    const dayCells = Array.from({ length: dim }, (_, i) => {                                      
      ...
      return (    
        <div
          ...
          className={[                                                                            
            'rounded-2xl p-1.5 md:p-2 min-h-[70px] md:min-h-[90px]',
            'cursor-pointer transition-all border group cal-cell',                                
            today                                                                                 
        ...
        >
          <div
            className={[
              'text-xs font-semibold mb-1 w-6 h-6',
              'flex items-center justify-center rounded-full',                                    
              today
                ? 'bg-purple-500 text-white'                                                      
                : 'text-slate-500 group-hover:bg-purple-50 group-hover:text-purple-600',
            ].join(' ')}                                                                          
          >
            {day}                                                                                 
          </div>  
